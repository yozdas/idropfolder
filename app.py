...
<body>
    <div class="card">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 16px; flex-wrap: wrap;">
            <div>
                <h1 style="margin: 0 0 8px 0;">iDropFolder - Güvenli Fotoğraf / Video Upload</h1>
            ...
            <div style="display: flex; align-items: center; gap: 12px; margin-top: 4px;">
                <a href="https://github.com/yozdas/idropfolder" target="_blank" title="GitHub Deposu" style="display: flex; align-items: center; color: #374151; text-decoration: none; font-size: 14px; font-weight: 500; gap: 6px;">
                    <svg height="20" width="20" viewBox="0 0 16 16" fill="currentColor" style="color: #1f2937;"><path d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.35 3.12.88.01.47.01.84.01.93 0 .22-.16.47-.55.38A8.013 8.013 0 0 1 0 8c0-4.42 3.58-8 8-8z"></path></svg>
                    GitHub
                </a>
                <span style="color: #d1d5db;">|</span>
                <a href="https://github.com/yozdas/idropfolder/issues" target="_blank" style="color: #4b5563; font-size: 13px; font-weight: normal; text-decoration: underline;">Sorun Bildir</a>
            </div>
        </div>
    ...
    <footer style="text-align: center; margin-top: 32px; padding: 16px 0; border-top: 1px solid #d1d5db; font-size: 14px; color: #6b7280;">
        <p style="margin: 0;">
            <strong>iDropFolder</strong> &copy; 2026 - Yusuf Özdaş tarafından geliştirilmiştir.
        </p>
    </footer>
</body>
</html>
